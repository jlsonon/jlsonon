...
| :--- | :--- | :--- | :--- |
| **Keebs** | Cross-platform mechanical keyboard sound engine (macOS, Windows, Linux, Android) | `Swift 6`, `C# .NET 8`, `Python`, `WebAudio` | [Site](https://keebs.live) • [Code](https://github.com/jlsonon/keebs) |
